...
class ClientesTest < ApplicationSystemTestCase
  ...
  test "creating a Cliente" do
    ...
    fill_in "Data entrega", with: @cliente.data_entrega
    fill_in "Data inicial", with: @cliente.data_inicial
    fill_in "Nome", with: @cliente.nome
    fill_in "Servico", with: @cliente.servico
    fill_in "Status", with: @cliente.status
    fill_in "Telefone", with: @cliente.telefone
    fill_in "Valor", with: @cliente.valor
